...
- exact-head PHP and JavaScript syntax
- source, privacy, landing, accessibility, and permanent-cleanup contracts
- retained Federated Timeline, Federated Interactions, and Stories regressions
- complete cumulative schema and repeat-safe additive migration
- live MySQL 8.4 integration
- live MariaDB 11.4 integration
- no temporary patch workflow, payload, assembler, or self-modifying source in the final diff
- open draft PR with no merge until David Evans explicitly approves
