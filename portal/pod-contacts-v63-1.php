...
<section class="pc-panel pc-hero">
    <div><span class="pc-kicker">Connected POD communications · v63.2</span><h2>Call or message connected contacts.</h2><p class="pc-help">Public Call Us remains available. Connected relationships gain direct calling and private POD messaging.</p></div>
    <div class="pc-actions"><a class="pc-button secondary" href="<?=e(app_url('portal/pod-connections.php'))?>">Manage relationships</a><a class="pc-button secondary" href="<?=e(app_url('portal/pod-messages.php'))?>">POD messages</a><a class="pc-button secondary" href="<?=e(app_url('call-dave.php'))?>" target="_blank" rel="noopener">Public Call Us</a></div>
</section>
