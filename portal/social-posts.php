...
<section class="social-feed-stories">
<header>
<div><span>Stories</span><h2>Recent updates</h2></div>
<a href="<?=e(app_url('portal/publish-story.php?modal=1'))?>" data-publishing-open="story" aria-label="Add story">+</a>
</header>
...
<section class="social-feed-record">
<?php social_posts_render_card($post);?>
<div class="social-feed-record-actions">
<a href="<?=e(app_url('portal/publish-social-post.php?modal=1&id='.(int)$post['id']))?>" data-publishing-open="social-post" data-publishing-url="<?=e(app_url('portal/publish-social-post.php?modal=1&id='.(int)$post['id']))?>">Edit</a>
...
<h2>No posts yet.</h2>
<p>Create the first permanent post.</p>
<a href="<?=e(app_url('portal/publish-social-post.php?modal=1'))?>" data-publishing-open="social-post">Create post</a>
</section>
<?php endif;?>

<?php if($drafts):?>
<section class="social-feed-drafts">
<strong><?=count($drafts)?> draft<?=count($drafts)===1?'':'s'?></strong>
<div>
<?php foreach($drafts as $draft):?>
<a href="<?=e(app_url('portal/publish-social-post.php?modal=1&id='.(int)$draft['id']))?>" data-publishing-open="social-post" data-publishing-url="<?=e(app_url('portal/publish-social-post.php?modal=1&id='.(int)$draft['id']))?>"><?=e(mb_substr((string)($draft['body_text']?:'Untitled draft'),0,70))?></a>
<?php endforeach;?>
</div>
</section>
<?php endif;?>
...
<button class="pod-social-button" type="submit">Save settings</button>
</form>
</dialog>
