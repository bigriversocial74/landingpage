...
</div><form method="post" class="menu-delete-form" onsubmit="return confirm('Delete this menu?');"><?=csrf_field()?><input type="hidden" name="action" value="delete_site_menu"><input type="hidden" name="menu_id" value="<?=$menu['id']?>"><button class="button button-danger">Delete menu</button></form>
