...
<div class="ra-shell">
<section class="ra-panel ra-hero"><div><span class="ra-kicker">Agent receptionist routing · v63.4</span><h2>Control how connected calls are answered.</h2><p class="ra-muted">The receptionist uses approved public profile, portfolio, and blog sources. It can transfer, take messages, request callbacks, and optionally add browser voice without accessing private owner knowledge.</p></div><div class="ra-actions"><a class="ra-button secondary" href="<?=e(app_url('portal/pod-voice.php'))?>">Browser voice</a><a class="ra-button secondary" href="<?=e(app_url('portal/pod-contacts.php'))?>">POD contacts</a><a class="ra-button secondary" href="<?=e(app_url('portal/pod-messages.php'))?>">POD messages</a></div></section>
