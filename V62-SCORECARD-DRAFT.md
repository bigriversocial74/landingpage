...
|---|---:|---|
| Public RSS 2.0 output | 0/10 | No public feed endpoint or feed discovery metadata |
...
| Tests, documentation, and deployment | 0/10 | No schema, setup guide, regression suite, or deployment instructions |
