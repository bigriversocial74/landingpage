...
$checks = [
    ...
    ['local comment Create hook', 'federated_interactions_safe_comment_event($commentId, \'Create\'', $source['content']],
    ['local comment Update hook', 'federated_interactions_safe_comment_event($commentId, \'Update\'', $source['content']],
    ['local comment Delete hook', 'federated_interactions_safe_comment_event($commentId, \'Delete\'', $source['content']],
    ['local reaction hook', 'federated_interactions_safe_reaction_event(', $source['content']],
...
foreach ([
    ...
    'tools/fix-federated-interactions-delete-v66g.py',
    '.github/workflows/fix-federated-interactions-delete-v66g.yml',
] as $temporary) {
